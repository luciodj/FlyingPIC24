...
IMAGE_TYPE=debug
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/10-TempSense.${IMAGE_TYPE}.elf
else
...
ifneq ($(OS_CURRENT),$(OS_ORIGINAL))
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/10-TempSense.${IMAGE_TYPE}.elf
...
${OBJECTDIR}/TEMP.o: TEMP.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} -g -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1 -omf=elf -x c -c -mcpu=24FJ128GA010 -I"../../include" -MMD -MF ${OBJECTDIR}/TEMP.o.d -o ${OBJECTDIR}/TEMP.o TEMP.c 
ifneq (,$(findstring MINGW32,$(OS_CURRENT))) 
	 sed -e 's/\"//g' -e 's/\\$$/__EOL__/g' -e 's/\\ /__ESCAPED_SPACES__/g' -e 's/\\/\//g' -e 's/__ESCAPED_SPACES__/\\ /g' -e 's/__EOL__$$/\\/g' ${OBJECTDIR}/TEMP.o.d > ${OBJECTDIR}/TEMP.o.tmp
	${RM} ${OBJECTDIR}/TEMP.o.d 
	${CP} ${OBJECTDIR}/TEMP.o.tmp ${OBJECTDIR}/TEMP.o.d 
	${RM} ${OBJECTDIR}/TEMP.o.tmp}
else 
	 sed -e 's/\"//g' ${OBJECTDIR}/TEMP.o.d > ${OBJECTDIR}/TEMP.o.tmp
	${RM} ${OBJECTDIR}/TEMP.o.d 
	${CP} ${OBJECTDIR}/TEMP.o.tmp ${OBJECTDIR}/TEMP.o.d 
	${RM} ${OBJECTDIR}/TEMP.o.tmp}
endif
...
${OBJECTDIR}/TEMP.o: TEMP.c  nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} ${OBJECTDIR} 
	${RM} ${OBJECTDIR}/TEMP.o.d 
	${MP_CC}  -omf=elf -x c -c -mcpu=24FJ128GA010 -I"../../include" -MMD -MF ${OBJECTDIR}/TEMP.o.d -o ${OBJECTDIR}/TEMP.o TEMP.c 
ifneq (,$(findstring MINGW32,$(OS_CURRENT))) 
	 sed -e 's/\"//g' -e 's/\\$$/__EOL__/g' -e 's/\\ /__ESCAPED_SPACES__/g' -e 's/\\/\//g' -e 's/__ESCAPED_SPACES__/\\ /g' -e 's/__EOL__$$/\\/g' ${OBJECTDIR}/TEMP.o.d > ${OBJECTDIR}/TEMP.o.tmp
	${RM} ${OBJECTDIR}/TEMP.o.d 
	${CP} ${OBJECTDIR}/TEMP.o.tmp ${OBJECTDIR}/TEMP.o.d 
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/10-TempSense.${IMAGE_TYPE}.elf: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC}  -omf=elf  -mcpu=24FJ128GA010  -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1 -o dist/${CND_CONF}/${IMAGE_TYPE}/10-TempSense.${IMAGE_TYPE}.elf ${OBJECTFILES}      -Wl,--defsym=__MPLAB_BUILD=1,-Tp24FJ128GA010.gld,--defsym=__MPLAB_DEBUG=1,--defsym=__ICD2RAM=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_ICD3=1,-L"../../../../Program Files/Microchip/MPLAB C30/lib",-Map="$(TARGETBASE).map",--defsym=__ICD2RAM=1
else
dist/${CND_CONF}/${IMAGE_TYPE}/10-TempSense.${IMAGE_TYPE}.elf: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC}  -omf=elf  -mcpu=24FJ128GA010  -o dist/${CND_CONF}/${IMAGE_TYPE}/10-TempSense.${IMAGE_TYPE}.elf ${OBJECTFILES}      -Wl,--defsym=__MPLAB_BUILD=1,-Tp24FJ128GA010.gld,-L"../../../../Program Files/Microchip/MPLAB C30/lib",-Map="$(TARGETBASE).map",--defsym=__ICD2RAM=1
	${MP_CC_DIR}\\pic30-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/10-TempSense.${IMAGE_TYPE}.elf -omf=elf
endif
